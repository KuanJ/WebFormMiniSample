    ...
    <script>
        $(function () {
            $("#btnSave").click(function () {
                ...
                if (id) {
                    $.ajax({
                        url: "https://localhost:44316/Handlers/AccountingNoteHandler.ashx?actionName=update",
                        type: "POST",
                        data: {
                            "Caption": caption,
                            "Amount": amount,
                    ...
                    $.ajax({
                        url: "https://localhost:44316/Handlers/AccountingNoteHandler.ashx?actionName=create",
                        type: "POST",
                        data: {
                            "Caption": caption,
                            "Amount": amount,
