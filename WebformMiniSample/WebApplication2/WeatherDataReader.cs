...
namespace WebApplication2
{
    class WeatherDataReader
    {
        ...
        {
            string url = "https://opendata.cwb.gov.tw/fileapi/v1/opendataapi/F-B0053-037?Authorization=CWB-24D0D5F0-6913-44B8-8FDA-6766BF379610&downloadType=WEB&format=JSON";
